...
Приложение Java, которое подключается к базе данных sqlite, с помощью которого можно вставлять, удалять 
или изменять записи в базе данных. Данные внутри базы данных визуально отображаются в приложении.

![DVDApplication-1](https://raw.githubusercontent.com/evgenvandev/jekyll-gitbook/gh-pages/gitbook/images/java/java-sqlite/DVDApplication.png "DVDApplication-1")
